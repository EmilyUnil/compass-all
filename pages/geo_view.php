...
$('#date-range').daterangepicker({
    ...
    locale: {
        format: 'DD.MM.YYYY', applyLabel: 'Применить', cancelLabel: 'Отмена',
        fromLabel: 'С', toLabel: 'По', weekLabel: 'Н',
        daysOfWeek: ['Вс','Пн','Вт','Ср','Чт','Пт','Сб'],
        monthNames: ['Январь','Февраль','Март','Апрель','Май','Июнь',
                     'Июль','Август','Сентябрь','Октябрь','Ноябрь','Декабрь'],
        firstDay: 1
    },
    showDropdowns: true, autoApply: false, singleDatePicker: false,
});
$('#date-range').on('apply.daterangepicker', function() { loadGeoData(); });
